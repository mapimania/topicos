		...
		<div class="container">
			...
			<div class="agile_mail_grids">
				<div class="col-md-5 contact-left">
					<h4>Habla a</h4>
					<p>Mario Alberto Morales Morales en 
						<span>Zamora,Michoacán,México.</span></p>
					<ul>
						<li>Cel :351-168-6653</li>
						<li><a href="mapimaniamorales98@hotmail.com">mapimaniamorales98@hotmail.com</a></li>
					</ul>
				</div>
				<div class="col-md-7 contact-left">
					...
					<form action="#" method="post">
						...
						<textarea name="message" placeholder="Queja, sugerencia o pregunta..." required=""></textarea>
